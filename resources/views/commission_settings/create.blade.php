            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('commission.settings.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Tipe Layanan</label>
                                <select name="service_type" class="form-control">
                                    <option value="ride" {{ old('service_type') == 'ride' ? 'selected' : '' }}>Ride
                                    </option>
                                    <option value="food" {{ old('service_type') == 'food' ? 'selected' : '' }}>Food
                                    </option>
